        ...
        <div id="table">
            <table>
                ...
                <?php 
                    ...
                    $sql = 'SELECT idx, title, name, date_format(nows, "%Y/%m/%d") as nows FROM '.$tableName.' WHERE idx = ref and bkind = '.$_COMPANY_ID;
                ...
                ?>
                            <tr>
                                <td><?=$id?></td>
                                <td><a href="qna_view.php?idx=<?=$row["idx"]?>&page=<?=$page?>"><?=$row["title"]?></a></td>
                                <td><?=$row["name"]?></td>
                                <td><?=$row["nows"]?></td>
                            </tr>
                <?php
