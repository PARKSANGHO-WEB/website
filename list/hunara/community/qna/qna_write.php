...
<body>
    ...
    <div id="container">
        ...
        <div id="newContent">
            <form name="frm" action="qna_write_back.php" method="POST" enctype="multipart/form-data">
                <table>
                    <tr>
                        <th><label for="text_name">성명</label></th>
                        <td><input type="text" class="content" id="text_name" name="name" HNAME="성명" value="<?=$_SESSION['EMP_NM']?>" REQUIRED MAXBYTE="50" ></td>
                    </tr>
                    <tr>
                        <th><label for="text_email">이메일</label></th>
                        <td><input type="email" class="content" id="text_email" name="email" HNAME="이메일" value="<?=$_SESSION['EMP_EMAIL']?>" REQUIRED MAXBYTE="50" ></td>
                    </tr>
                    <tr>
