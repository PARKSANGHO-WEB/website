...
;(function($){
    $.fn.pgwSlider = function(options) {
        ...
        var fadeElement = function(element) {
            ...
            // Update list items
            pgwSlider.plugin.find('.ps-list > li').css('opacity', '1').removeClass('on');
            pgwSlider.plugin.find('.ps-list > li.elt_' + element.id).css('opacity', '1').addClass('on');
