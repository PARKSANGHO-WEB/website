...
$query = "select a.idx, a.title, a.name, a.hit ,date_format(a.nows,'%Y.%m.%d') as nows from tb_qa a where 1=1 and idx = ref ".$where.$order_by;
$query_cnt = "select idx from tb_qa a where 1=1 and idx = ref ".$where;
