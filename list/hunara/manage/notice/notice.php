...
function getList(){
    $("#list").jqGrid({
		...
		datatype: "json",
		mtype: "post",
		colNames: [ "선택", "번호", "기업명", "제목", "작성자", "작성일", "조회수","수정"],
		colModel: [
            ...
            { name: "comname", sortable:true, align:"left", width: 100},
			...
			{ name: "btn", sortable:false, align:"center", width: 80, formatter:formatOpt1}
			],
		pager: "#pager",
		rowNum: 10,
		sortname: "no",
...
function view(idx){
    ...
    document.location.href = "notice-view.php?idx="+idx;
}
