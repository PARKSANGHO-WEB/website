...
function getList(){ 
    ...
    $("#list").jqGrid({
		...
		colModel: [
			...
			{ name: "useday", label:"예약일", sortable:true, align:"center", width: 120},
            ...
            { name: "payflag", label:"입금여부", sortable:true, align:"center", width: 94},
            { name: "per_amount", label:"부담금", sortable:true, align:"center", width: 94},
            { name: "mdate", label:"승인날짜", sortable:true, align:"center", width: 94},
            { name: "cancel_date", label:"취소날짜", sortable:true, align:"center", width: 94},
...
function selRowProc(mode){
    ...
    if(dataList.length < 1){
        ...
        if(confirm(txt+" 하시겠습니까?" )){        
            ...
            $.ajax({
                url		: "/manage/reserve/reserve-pay-proc.php",
                type	: "POST",
