...
$thum_img_old = trim(sqlfilter($_REQUEST['thum_img_old']));
$contact_file_old = trim(sqlfilter($_REQUEST['contact_file_old']));
...
if($is_html != "Y"){
	...
	if($result){
        ...
        $sql2 = "delete from tb_huType where idx = {$idx} ";
        ...
        $sql2 = "delete from tb_huFile where idx = {$idx} ";
        $result2 = mysqli_query($gconnet,$sql2);
