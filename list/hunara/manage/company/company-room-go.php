...
function getList(){
	...
	$("#list").jqGrid({
		...
		mtype: "post",
        postData : dataArr,
		colNames: [ "선택", "번호", "등록일", "기업명", "휴양소명", "평형" , "구분", "기간", "숙박일", "총 개수", "잔여 개수", "1차", "2차", "3차", "4차","가림여부", "midx", "hidx", "seq", "cidx", "endDate" ],
		colModel: [
            ...
            { name: "hide_yn", sortable:true, align:"center", width: 72},
...
function doChuchum(step){
    ...
    if(confirm(step+'차 추첨 하시겠습니까')){
        ...
        $.ajax({
            //url		: "/manage/company/company-room-go-proc.php",
				...
				<form action="#">
					<div class="view-c">
						<div class="view-mana">
							...
							<div class="gosel-btn">
								<div class="resultBtn">
									<span class="ct-t">당첨결과</span>
									<span class="ct-c">
										<button type="button" onClick="hide();">가리기</button>
										<button type="button" onClick="show();">보여지기</button>
									</span>
									<span class="gsb-warn">
