...
<head>
    ...
    <meta charset="UTF-8">
    <title>K-DOT</title>
    <link rel="stylesheet" href="../css/products_doctorBuy3.css">
    <style>
/*        상단 배너 배경 이미지 변경*/
    ...
    <div id="products3">
		<div class="header cf">
			...
			?>
					...
					<!-- <div class="img-big"><img src="../img/sangse/derma-3s1.png" alt=""></div>
					<div class="img-big"><img src="../img/sangse/derma-3s2.png" alt=""></div>
					<div class="img-big"><img src="../img/sangse/derma-3s3.png" alt=""></div>
					<div class="img-big"><img src="../img/sangse/derma-3s4.png" alt=""></div> -->
				</div>
			...
			?> 
				...
				<!-- 	<div class="img-sm"><img src="../img/sangse/derma-3s1.png" alt=""></div>
					<div class="img-sm"><img src="../img/sangse/derma-3s2.png" alt=""></div>
					<div class="img-sm"><img src="../img/sangse/derma-3s3.png" alt=""></div>
					<div class="img-sm"><img src="../img/sangse/derma-3s4.png" alt=""></div> -->
		        </div>
		    </div>
			<script>
        ...
        <section class="items">
			...
			<article class="content">
		        <div class="img cf">
		            ...
		            <div class="img3">
						<img src="<?=$_P_DIR_WEB_FILE?>goods/img_thumb/<?=$row_file2['treatment_img_c1_2']?>" alt="">
		            </div>
		        </div>
		        <div class="text cf">
		            <div class="txt1">
           ...
           <article class="content">
			<div class="img cf">
		            ...
		            <div class="img3">
						<img src="<?=$_P_DIR_WEB_FILE?>goods/img_thumb/<?=$row_file2['treatment_img_c2_2']?>" alt="">
		            </div>
		        </div>
		        <div class="text cf">
		            <div class="txt1">
          ...
          <article class="content">
			<div class="img cf">
		            ...
		            <div class="img3">
						<img src="<?=$_P_DIR_WEB_FILE?>goods/img_thumb/<?=$row_file2['treatment_img_c3_2']?>" alt="">
		            </div>
		        </div>
		        <div class="text cf">
		            <div class="txt1">
		  ...
		  ?>
		   <article class="content">
			<div class="img cf">
		            ...
		            <div class="img3">
						<img src="<?=$_P_DIR_WEB_FILE?>goods/img_thumb/<?=$row_file2['treatment_img_c6_2']?>" alt="">
		            </div>
		        </div>
		        <div class="text cf">
		            <div class="txt1">
		  ...
		  <?}?>
		   ...
		   <article class="content">
			<div class="img cf">
		            ...
		            <div class="img3">
						<img src="<?=$_P_DIR_WEB_FILE?>goods/img_thumb/<?=$row_file2['treatment_img_c7_2']?>" alt="">
		            </div>
		        </div>
		        <div class="text cf">
		            <div class="txt1">
		  ...
		  <article class="content">
			<div class="img cf">
		            ...
		            <div class="img3">
						<img src="<?=$_P_DIR_WEB_FILE?>goods/img_thumb/<?=$row_file2['treatment_img_c8_2']?>" alt="">
		            </div>
		        </div>
		        <div class="text cf">
		            <div class="txt1">
		 ...
		 <article class="content">
			<div class="img cf">
		            ...
		            <div class="img3">
						<img src="<?=$_P_DIR_WEB_FILE?>goods/img_thumb/<?=$row_file2['treatment_img_c4_2']?>" alt="">
		            </div>
		        </div>
		        <div class="text cf">
		            <div class="txt1">
