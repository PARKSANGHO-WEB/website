		...
		<div class="sub-con">
			<form action="#">
				<table class="qna-write">
					...
					<tr>
						...
						<td>
								...
								<input type="text" class="only-num" maxlength="4" placeholder="1234">
								<span class="hypen">-</span>
								<input type="text" class="only-num" maxlength="4" placeholder="1234">
					...
					<tr>
						<td>답변받을 이메일</td>
						<td>
								<input type="text" placeholder="idididididid">
					...
					<tr>
						<td>문의내용</td>
						<td>
							<textarea name="text" id="write-con">문의내용입니다.</textarea>
						</td>
					</tr>
					<tr>
						<td>파일첨부</td>
				...
				<div class="write-btn">
					...
					<button type="button" onclick="history.back(-1); return false;">취소</button>
				</div>
			</form>
		</div>
	</section>
