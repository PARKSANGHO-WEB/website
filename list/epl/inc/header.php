...
<body>
	...
	<div class="pc-menu">
		...
		<div class="pc-menuc">
			<ul>
				<li><a href="./sub/intro.php">EPL 소개</a></li>
				<li><a href="./sub/membership.php">EPL 멤버십</a></li>
				<li><a href="./sub/way.php">EPL Courses</a></li>
				<li><a href="./sub/notice.php">커뮤니티</a></li>
			</ul>
		</div>
	</div>
