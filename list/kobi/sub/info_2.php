...
<? include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/include_default.php"; // 공통함수 인클루드 ?>
    ...
    <div id="navbar" class="info_tab">
        <div class="at-wrap">
        <a href="../main.php" class="home">
            <img class="" src="../img/sub/home.png" alt="">
        </a>
            <a href="./info_1.php" class="dot">이용안내</a>
            <a href="./info_2.php" class="dot active">공지사항</a>
        </div>
    </div>
...
$query_cnt2 = "select is_popup from board_content a where 1=1 and is_popup='Y'".$where;
...
?>
	...
	function go_view(no,bcode){
		location.href = "./info_2_view.php?idx="+no+"&bbs_code="+bcode+"&pageNo=<?=$pageNo?>&field=<?=$field?>&keyword=<?=$keyword?>";
	}
	...
	function go_search() {
        ...
        <div class="notice">
            ...
            <div class="fc1-search">
                <div class="sr-wrap">
				<form name="s_mem" id="s_mem" method="post" action="info_2.php">
           ...
           <form action="#">
                <table>
					...
					<? if($num==0) { ?>
					<tr>
						<td colspan="5" ><strong>등록된 공지사항이 없습니다.</strong></td>
					</tr>
				<? } ?>
		...
		?> 
				<tr>
                        <td><p>[공지]</p></td>
                        <td class="notice-on" onClick="javascript:go_view('<?=$row_sub_notice[idx]?>','<?=$row_sub_notice['bbs_code']?>');"  style="cursor: pointer;"><p><?=string_cut2(stripslashes($row_sub_notice[subject]),40)?></p></td>
                        <td><p><?=$row_sub_notice[writer]?></p></td>
                        <td><p><?=substr($row_sub_notice[write_time],0,10)?></p></td>
                        <td><p><?=$row_sub_notice[cnt]?></p></td>
                    </tr>
	...
	?>	
			...
			for ($i=0; $i<mysqli_num_rows($result); $i++){
				...
				?>
					<tr>
                        <td><p><?=$listnum?></p></td>
                        <td onClick="javascript:go_view('<?=$row[idx]?>','<?=$row['bbs_code']?>');" style="cursor: pointer;"><p><?=string_cut2(stripslashes($row[subject]),70)?></p></td>
                        <td><p><?=$row[writer]?></p></td>
                        <td><p><?=substr($row[write_time],0,10)?></p></td>
                        <td><p><?=$row[cnt]?></p></td>
                    </tr>
				<?}?>	
					

                    <!-- <tr onClick="location.href='./info_2_view.html'">
                        <td><p>556</p></td>
                        <td><p>제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다. 제목입니다.</p></td>
                        <td><p>코비인사이트</p></td>
                        <td><p>2020-07-21</p></td>
                        <td><p>80</p></td>
                    </tr>
                    <tr onClick="location.href='./info_2_view.html'">
                        <td><p>556</p></td>
