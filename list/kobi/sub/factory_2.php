...
<? include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/include_default.php"; // 공통함수 인클루드 ?>
    ...
    <div id="navbar" class="about_tab">
        ...
        <a href="../main.php" class="home">
            ...
            <a href="./factory_2.php" class="dot active">컨설팅 사례</a>
...
?>
	...
	function go_view(no,bcode){
		location.href = "./factory_2_view.php?idx="+no+"&bbs_code="+bcode+"&pageNo=<?=$pageNo?>&field=<?=$field?>&keyword=<?=$keyword?>&bbs_sect2=<?=$bbs_sect2?>";
	}
	
	function go_list(){

		//location.href = "factory_2.php?<?=$total_param?>&go_div=board_list_area";
		location.href = "factory_2.php?<?=$total_param?>";

	}
	
	function go_list2(bbs_sect2){
	
		//location.href = "factory_2.php?<?=$total_param?>&bbs_sect2="+bbs_sect2+"&go_div=board_list_area";
		location.href = "factory_2.php?<?=$total_param?>&bbs_sect2="+bbs_sect2;
	}
...
<script>
   ...
   $(document).ready(function(){
      fnMove("<?=$_REQUEST['go_div']?>");
        ...
        <div class="fac2-1 sector" id="board_list_area">
            <p class="consult-ment"><span class="bold">코비인사이트</span>에서 진행했던<br /><span class="bold">컨설팅 사례들</span>을 공유합니다.</p>
			 ...
			 <div class="filter-btn">
               <ul id="filterOptions">
                    ...
                    <li class="<?if($bbs_sect2=='기타')echo 'active';?>"><a class="any" href="javascript:go_list2('기타');" >기타</a></li>
                 </ul>
            </div>
			
            <div class="fc1-search">
                <div class="sr-wrap">
				<form name="s_mem" id="s_mem" method="post" action="factory_2.php">
			...
			<div id="ourHolder">
              ...
              <div class="item <?=$bbs_sect2_str?>" onclick="javascript:go_view('<?=$row[idx]?>','<?=$row['bbs_code']?>');">
                    <div class="tw-top">
                        <img src="<?=$_P_DIR_WEB_FILE?><?=$bbs_code?>/img_thumb/<?=$row_file['file_chg']?>">
						<div class="tw-opa">
                            <span></span>
                        </div>
                    </div>
                    <div class="tw-mid">
                        <p class="tw-title"><?=nl2br($row[subject])?></p>
                        <p class="tw-con"><?=strip_tags($row[content])?></p>
                    </div>
                    <div class="tw-bot">
                        <div class="twb-l">
                            <span class="tw-cate">
            ...
            <!-- <div id="ourHolder">
              <div class="item semu" onclick='location.href="./factory_2_view.php"'>
                    <div class="tw-top">
                        <div class="tw-opa">
                            <span></span>
                        </div>
                    ...
                    <div class="tw-mid">
                        <p class="tw-title">협력사 높이 맞춘 계약<br />업무로 만족도 제고</p>
                        <p class="tw-con">동서발전, 협력사 눈높이 맞춘 계약<br />업무로 만족도 제고</p>
                    </div>
                    <div class="tw-bot">
                        <div class="twb-l">
                            <span class="tw-cate">
              ...
              <div class="item bub" onclick='location.href="./factory_2_view.html"'>
                    <div class="tw-top">
                        <div class="tw-opa">
                            <span></span>
                        </div>
              ...
              <div class="item serty" onclick='location.href="./factory_2_view.html"'>
                    <div class="tw-top">
                        <div class="tw-opa">
                            <span></span>
                        </div>
              ...
              <div class="item any" onclick='location.href="./factory_2_view.html"'>
                    <div class="tw-top">
                        <div class="tw-opa">
                            <span></span>
                        </div>
              ...
              <div class="item nomu" onclick='location.href="./factory_2_view.html"'>
                    <div class="tw-top">
                        <div class="tw-opa">
                            <span></span>
                        </div>
                ...
                $(document).ready(function() {
                  $('#filterOptions li a').click(function() {
                    ...
                    if(ourClass == 'all') {
                      ...
                      $('#ourHolder').children('div:subtent(.' + ourClass + ')').hide();
