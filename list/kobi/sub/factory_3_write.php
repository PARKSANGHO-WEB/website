...
<SCRIPT LANGUAGE="JavaScript">
	alert('상담실(Q&A)게시판은 회원만 작성이 가능합니다.');
...
?>
        <div class="fac3w-1">
            <p class="qna-ment">컨설팅에 관한 <span class="bold">궁금한 점</span>을 남겨주세요.<br />코비인사이트의<span class="bold"> 전문가들</span>이 친절하게 답변 드립니다.</p>
            <div id="ourHolder">
                   <form action="factory_3_write_action.php" name="frm" id="frm" method="post" enctype="multipart/form-data">
				     <input type="hidden" name="bbs_code" value="qna">
				   	<input type="hidden" name="ip" value="<?= $_SERVER['REMOTE_ADDR']?>">
					 <input type="hidden" name="writer" readonly value="<?=$sel_row[user_name]?>">
                            <input type="hidden" name="email" readonly value="<?=$sel_row[user_id]?>">
                            <input type="hidden" name="cell" readonly value="<?=$sel_row[cell]?>">
							<input type="hidden" name="com_name" readonly value="<?=$sel_row[com_name]?>"> 

							<input type="hidden" name="attach_count_1" id="attach_count_1" value="0"/>
							<input type="hidden" name="attach_count_ext_1" id="attach_count_ext_1" value="0"/>
					...
					<div class="fc3w-form">
						...
						<div class="fc3w-cate">
                            <p>분야</p>
                            <label for="all_s">
                                <input name="bbs_sect2" id="all_s" type="radio" value="세무">
                                세무
                            </label>
                            <label for="all_b">
                                <input name="bbs_sect2" id="all_b"  type="radio" value="법무">
                                법무
                            </label>
                            <label for="all_n">
                                <input name="bbs_sect2" id="all_n"  type="radio" value="노무">
                                노무
                            </label>
                            <label for="all_t">
                                <input name="bbs_sect2" id="all_t"  type="radio" value="인증">
                                인증
                            </label>
                            <label for="all_any">
                                <input name="bbs_sect2" id="all_any"  type="radio" value="기타">
                                기타
                            </label>
                        </div>
                        <div class="fc3w-cont">
...
function set_upload_file(){
	...
	if(Number($("#attach_count_1").val()) >= 6){
		...
		cur_file = $("#docu_"+count_pre+"").val();
		if (cur_file == ""){ // 파일창을 오픈한 뒤 선택하지 않고 그냥 닫음
			var deldev = document.getElementById("added_1_"+count_pre);
			addedFormDiv.removeChild(deldev); // 폼 삭제 
		}*/
