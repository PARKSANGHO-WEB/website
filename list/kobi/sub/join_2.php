...
function go_submit() {
			...
			if(document.frm.birthday1.value == ''){
				alert('주민등록번호 첫자리를 입력하세요');
				document.frm.birthday1.focus();
				return false;
			}


			if(document.frm.birthday2.value == ''){
				alert('주민등록번호 뒷자리를 선택하세요');
				document.frm.birthday2.focus();
				return false;
			}
				...
				<input type="hidden" name="sns_kind" id="sns_kind" value="<?=$sns_kind?>"/>  
					...
					<div class="form-wrap">
					   ...
					   <div class="line_3">
						...
						<div class="line_1">
                            <div class="line_1right">
                                <div class="text-box">
                                    <p><span class="u-title">코비인사이트(주) 홈페이지 개인정보처리방침</span><br /><br />
