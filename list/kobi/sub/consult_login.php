...
<!--             <p class="qna-ment"></p>
             -->            <div id="ourHolder">
                   <form action="consult_login_action.php" name="frm" id="frm" method="post" enctype="multipart/form-data">
				   <input type="hidden" name="bbs_code" value="qna2">
				   	<input type="hidden" name="ip" value="<?= $_SERVER['REMOTE_ADDR']?>">
					<input type="hidden" name="email" value="<?=$sel_row['email']?>">
					<input type="hidden" name="cell" value="<?=$sel_row['cell']?>">
                    <div class="fc3w-form">
                        <div class="fc3w-name">
                            <p>이름</p>
                            <input type="text" name="writer" placeholder="홍길동" readonly value="<?=$sel_row['user_name']?>">
                        </div>
                        <div class="fc3w-date">
                            <p>날짜</p>
                            <input type="text" name="write_time" placeholder="2020-07-25"  readonly value="<?=date('Y-m-d')?>">
                        </div>
                        <div class="fc3w-cate">
                            <p>분야</p>
                            <label for="all_s">
                        ...
                        <div class="fc3w-comp">
                            <p>회사명</p>
                            <input type="text" name="com_name"  readonly value="<?=$sel_row['com_name']?>">
                        </div>  
				...
				for($file_i=0; $file_i<1; $file_i++){
					$file_k = $file_i+1;
		   ?>
                                <input type="file" required="no" message="기타 첨부자료" name="file_<?=$file_i?>" id="file_<?=$file_i?>">
				<?
					}
				?>
