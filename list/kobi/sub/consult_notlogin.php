...
<? include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/include_default.php"; // 공통함수 인클루드 ?>
    ...
    <div id="navbar" class="about_tab">
        ...
        <a href="javascript:;" class="home">
            ...
            <a class="dot active">진행현황</a>
            <a class="dot">컨설팅 사례</a>
            <a class="dot">상담실(Q&A)</a>
            <a class="dot">FACTORY(자료실)</a>
            <a class="dot">공작소(자료제작)</a>
        </div>
    </div>
...
<!--             <p class="qna-ment"></p>
             -->            <div id="ourHolder">
                   <form action="consult_notlogin_action.php" name="frm" id="frm" method="post" enctype="multipart/form-data">
				   <input type="hidden" name="bbs_code" value="qna2">
                    ...
                    <div class="fc3w-form">
                        ...
                        <div class="fc3w-date">
                            <p>날짜</p>
                            <input type="text" placeholder="2020-07-25" readonly value="<?=date('Y-m-d')?>">
                        </div>
                        <div class="fc3w-phone">
                            <p>연락처</p>
