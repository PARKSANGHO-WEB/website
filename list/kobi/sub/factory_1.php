...
<? include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/include_default.php"; // 공통함수 인클루드 ?>
    ...
    <div id="navbar" class="about_tab">
        ...
        <a href="../main.php" class="home">
            ...
            <a href="./factory_1.php" class="dot active">진행현황</a>
            <a href="./factory_2.php" class="dot">컨설팅 사례</a>
            <a href="./factory_3.php" class="dot">상담실(Q&A)</a>
...
<?
	$sql1 = "select * from consul_prog_cnt where 1=1 order by idx desc limit 0,1";
	$res1 = mysqli_query($gconnet,$sql1);
	$row1 = mysqli_fetch_array($res1);

	$mdate=date_create($row1[mdate]);
	$mdate_str=date_format($mdate,'Y.m.d');	
?>
        <div id="fac_1">
            <div class="facb_wrap">
                <div class="fc-boxt">
                    ...
                    <div class="fcbt-l2">
                        <div class="number-all">
                           <div class='numCounter' data-value='<?=$row1[prog_10000].$row1[prog_1000].$row1[prog_100].$row1[prog_ten].$row1[prog_one]?>'></div>
                        </div>
                    </div>
                    <div class="fcbt-b">
                        <ul>
                        <li class="circle_bg circle_bg1">
                            <div class="circle_g">
                              <div class="single-chart">
                                ...
                                <div class="text-wrap">
                                    <span class="title">세무</span>
                                    <span class="t-num" id="num_se"></span>
                                </div>
                              </div>
                            </div>
                        </li>
                        <li class="circle_bg circle_bg2">
                            <div class="circle_g">
                              <div class="single-chart">
                                ...
                                <div class="text-wrap">
                                <span class="title">법무</span>
                                    <span class="t-num" id="num_bub"></span>
                                </div>
                              </div>
                            </div>
                        </li>
                        <li class="circle_bg circle_bg3">
                            <div class="circle_g">
                              <div class="single-chart">
                                ...
                                <div class="text-wrap">
                                    <span class="title">노무</span>
                                    <span class="t-num" id="num_no"></span>
                                </div>
                              </div>
                            </div>
                        </li>
                        <li class="circle_bg circle_bg4">
                            <div class="circle_g">
                              <div class="single-chart">
                                ...
                                <div class="text-wrap">
                                    <span class="title">인증</span>
                                    <span class="t-num" id="num_ser"></span>
                                </div>
                              </div>
                            </div>
                        </li>
                        <li class="circle_bg circle_bg5">
                            <div class="circle_g cg-last">
                              <div class="single-chart">
                                <svg viewBox="0 0 36 36" class="circular-chart orange">
                                  <path class="circle-bg"
                                    d="M18 2.0845
                                ...
                                <div class="text-wrap">
                                    ...
                                    <span class="t-num" id="num_any"></span>
                                </div>
                              </div>
                            </div>
                        </li>
          ...
          <script>
            $(document).ready(function() {
                ...
                var ignite = new CountUp("num_se", 0, <?=$row1[tex1]?>, 0, 2, options);
                ignite.start();
                ...
                var ignite2 = new CountUp("num_bub", 0, <?=$row1[law1]?>, 0, 2, options);
                ignite2.start();
                ...
                var ignite3 = new CountUp("num_no", 0, <?=$row1[work1]?>, 0, 2, options);
                ignite3.start();
                ...
                var ignite4 = new CountUp("num_ser", 0, <?=$row1[auth1]?>, 0, 2, options);
                ignite4.start();
                ...
                var ignite5 = new CountUp("num_any", 0, <?=$row1[etc1]?>, 0, 2, options);
                ignite5.start();
...
Counter.prototype = { 
  ...
  count( newVal ){
    ...
    var counterInterval = setInterval(randomCount, 8000)
                ...
                <div class="fcbt_num">
                    <div class="fcn_box">
                        ...
                        <div class="fcb_n">
                            <ul>
                                <li>
                                    <span class="moneyt-1">경정청구</span>
                                    <span class="moneyn-1"><?=$row1[tex2]?></span>
                                </li>
                                <li>
                                    <span class="moneyt-2">주식이동</span>
                                    <span class="moneyn-2"><?=$row1[tex3]?></span>
                                </li>
                                <li>
                                    <span class="moneyt-3">이익환원</span>
                                    <span class="moneyn-3"><?=$row1[tex4]?></span>
                                </li>
                                <li>
                                    <span class="moneyt-4">부동산 관련</span>
                                    <span class="moneyn-4"><?=$row1[tex5]?></span>
                                </li>
                                <li>
                                    <span class="moneyt-5">기타 세무</span>
                                    <span class="moneyn-5"><?=$row1[tex6]?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="fcn_box">
                        ...
                        <div class="fcb_n">
                            <ul>
                                <li>
                                    <span class="Legalt-1">상업등기</span>
                                    <span class="Legaln-1"><?=$row1[law2]?></span>
                                </li>
                                <li>
                                    <span class="Legalt-2">정관개정</span>
                                    <span class="Legaln-2"><?=$row1[law3]?></span>
                                </li>
                                <li>
                                    <span class="Legalt-3">법인설립</span>
                                    <span class="Legaln-3"><?=$row1[law4]?></span>
                                </li>
                                <li>
                                    <span class="Legalt-4">각종 인허가</span>
                                    <span class="Legaln-4"><?=$row1[law5]?></span>
                                </li>
                                <li>
                                    <span class="Legalt-5">기타 법무</span>
                                    <span class="Legaln-5"><?=$row1[law6]?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="fcn_box">
                        ...
                        <div class="fcb_n">
                            <ul>
                                <li>
                                    <span class="labort-1">노무규정정비</span>
                                    <span class="laborn-1"><?=$row1[work2]?></span>
                                </li>
                                <li>
                                    <span class="labort-2">고용지원금</span>
                                    <span class="laborn-2"><?=$row1[work3]?></span>
                                </li>
                                <li>
                                    <span class="labort-3">노무분쟁</span>
                                    <span class="laborn-3"><?=$row1[work4]?></span>
                                </li>
                                <li>
                                    <span class="labort-4">고용산재환급</span>
                                    <span class="laborn-4"><?=$row1[work5]?></span>
                                </li>
                                <li>
                                    <span class="labort-5">기타 노무</span>
                                    <span class="laborn-5"><?=$row1[work6]?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="fcn_box">
                        ...
                        <div class="fcb_n">
                            <ul>
                                <li>
                                    <span class="serti-1">연구소 설립/관리</span>
                                    <span class="serti-1"><?=$row1[auth2]?></span>
                                </li>
                                <li>
                                    <span class="serti-2">기타 인증</span>
                                    <span class="serti-2"><?=$row1[auth3]?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="fcn_box">
                        ...
                        <div class="fcb_n">
                            <ul>
                                <li>
                                    <span class="elset-1">특허관련</span>
                                    <span class="elsen-1"><?=$row1[etc2]?></span>
                                </li>
                                <li>
                                    <span class="elset-2">신용등급관리</span>
                                    <span class="elsen-2"><?=$row1[etc3]?></span>
                                </li>
                                <li>
                                    <span class="elset-3">디자인 지원</span>
                                    <span class="elsen-3"><?=$row1[etc4]?></span>
                                </li>
                                <li>
                                    <span class="elset-4">제안서/사업계획서</span>
                                    <span class="elsen-4"><?=$row1[etc5]?></span>
                                </li>
                                <li>
                                    <span class="elset-5">기타 경영관련</span>
                                    <span class="elsen-5"><?=$row1[etc6]?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
?>
   ...
   $(document).ready(function(){
      fnMove("<?=$_REQUEST['go_div']?>");
			...
			<div class="fc1_table " id="board_list_area">
                        <form action="#">
                            <div class="fc1-search">
                                <div class="sr-wrap">
                             	<form name="s_mem" id="s_mem" method="post" action="factory_1.php">
			...
			<tr>
                                        ...
                                        <td><span class="writer"><?=$row[com_name]?></span></td>
                                        <td><span class="name"><?=$row[writer]?></span></td>
                                        <td><span class="category"><?=$row[bbs_sect2]?></span></td>
                                        <td><span class="title"><?=string_cut2(stripslashes($row[subject]),70)?></span></td>
                                        <td><span class="ing"><?=$row[bbs_sect4]?></span></td>
                                    </tr>
			...
			?>
                                    <!-- <tr>
                                        ...
                                        <td><span class="writer">디알컴퍼니</span></td>
                                        <td><span class="name">김수정</span></td>
                                        <td><span class="category">세무</span></td>
                                        <td><span class="title">제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.</span></td>
                                        <td><span class="ing">진행중</span></td>
                                    </tr>
                                    <tr>
                                        <td><span class="date">2020-07-21</span></td>
                                        <td><span class="writer">디알컴퍼니</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="writer">디알컴퍼니</span></td>
                                        <td><span class="name">김수정</span></td>
                                        <td><span class="category">법무</span></td>
                                        <td><span class="title">제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.</span></td>
                                        <td><span class="ing">진행중</span></td>
                                    </tr>
                                    <tr>
                                ...
                                <!--     <a href="javascript:;"><img src="../img/sub/b-all.jpg" alt=""></a>
                                    <a href="javascript:;"><img src="../img/sub/b-al.jpg" alt=""></a>
                                    <a class="active" href="javascript:;">1</a>
                                    <a href="javascript:;">2</a>
                                    <a href="javascript:;">3</a>
                                    <a href="javascript:;">4</a>
                                    <a href="javascript:;">5</a>
                                    <a href="javascript:;"><img src="../img/sub/b-ar.jpg" alt=""></a>
                                    <a href="javascript:;"><img src="../img/sub/b-arr.jpg" alt=""></a> -->
                                </div>
                            </div>
                        </form>
                    </div>
