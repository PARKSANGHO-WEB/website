...
<? include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/include_default.php"; // 공통함수 인클루드 ?>
    ...
    <div id="navbar" class="about_tab">
        ...
        <a href="../main.php" class="home">
            ...
            <a href="./factory_4.php" class="dot active">FACTORY(자료실)</a>
...
?>
            ...
            function myFunction() {
              if (window.pageYOffset >= sticky) {
				...
				function go_view(no,bcode){
					location.href = "./factory_4_view.php?idx="+no+"&bbs_code="+bcode+"&pageNo=<?=$pageNo?>&field=<?=$field?>&keyword=<?=$keyword?>&bbs_sect2=<?=$bbs_sect2?>";
				}
				
				function go_list(){

					//location.href = "factory_4.php?<?=$total_param?>&go_div=board_list_area";
					location.href = "factory_4.php?<?=$total_param?>";
				}

				function go_list2(bbs_sect2){
						
						//location.href = "factory_4.php?<?=$total_param?>&bbs_sect2="+bbs_sect2+"&go_div=board_list_area";
						location.href = "factory_4.php?<?=$total_param?>&bbs_sect2="+bbs_sect2;
				}
   ...
   $(document).ready(function(){
      fnMove("<?=$_REQUEST['go_div']?>");
        ...
        <div class="fac4-1 " id="board_list_area">
        <p class="fac4-ment"> <span class="bold">기업경영</span>에 참고할 수 있는<br /> <span class="bold">각 분야별 자료들</span>을 공유합니다.</p>
		<div class="filter-btn">
            ...
            <div class="fc1-search">
                <div class="sr-wrap">
				<form name="s_mem" id="s_mem" method="post" action="factory_4.php">
...
<!--                                     <th>답변글</th> -->
	...
	<?
		...
		?> 
								...
								<tr class="item">
                                    <td><span class="dic">[공지]</span></td>
									<td><span class="type"><?=$row_sub_notice['bbs_sect2']?></span></td>
                                    <td style="cursor: pointer;" onclick="javascript:go_view('<?=$row_sub_notice[idx]?>','<?=$row_sub_notice['bbs_code']?>')"><span class="title"><?=string_cut2(stripslashes($row_sub_notice[subject]),70)?></span></td>
<!--                                     <td><span class="ans">1</span></td> -->
	...
	?>	
			...
			?>
								<tr class="item">
                                    <td><span class="dic"><?=$listnum?></span></td>
									<td><span class="type"><?=$row['bbs_sect2']?></span></td>
                                    <td style="cursor:pointer;" onclick="javascript:go_view('<?=$row[idx]?>','<?=$row['bbs_code']?>')"><span class="title"><?=string_cut2(stripslashes($row[subject]),70)?></span></td>
<!--                                     <td><span class="ans">1</span></td> -->
			...
			?>
                                <!-- <tr class="item bub">
                                    ...
                                    <td onclick='location.href="./factory_4_view.html"'><span class="title">제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.제목입력창입니다.</span></td>
                                    <td><span class="ans">1</span></td>
