...
?>
<SCRIPT LANGUAGE="JavaScript">
	alert('FACTORY(자료실)게시판은 회원만 열람이 가능합니다.');
...
?>
        ...
        <div class="fac3v-1">
            ...
            <div id="ourHolder">
                       <form action="#">
                                ...
                                <tr class="v-info">
                                    <td>
                                        <div class="fcw-p">
                                             ...
                                             <span class="fcw-c"><?=$row[writer]?></span>   
                                        </div>
                                        <div class="fcw-d">
										...
										?>
                                             <span class="fcw-ft">첨부파일</span>   
                                             <span class="fcw-file"><a href="/pro_inc/download_file.php?nm=<?=$row_file['file_chg']?>&on=<?=$row_file['file_org']?>&dir=<?=$row['bbs_code']?>" target="_blank" download ><?=$row_file['file_org']?></a></span>
                                             <span class="file-size">(33.3kb)</span>   
                                        </div>
                                    </td>
                                </tr>
                                <tr class="v-con">
                        ...
                        <div class="back-btn">
                            <button onclick="goBack()" type="button">목록으로</button>
		...
		<? } else { ?>	
				<a class="prev-write" href="factory_4_view.php?idx=<?=$up_row['idx']?>&bbs_code=<?=$bbs_code?>&bbs_sect2=<?=$bbs_sect2?>">다음글</a>	
		<?}?>		
		<?
		...
		?>
				<a class="next-write" href="factory_4_view.php?idx=<?=$down_row['idx']?>&bbs_code=<?=$bbs_code?>&bbs_sect2=<?=$bbs_sect2?>">이전글</a>           
		<?}?>	
                        </div>
                    </form>
                    <script>
