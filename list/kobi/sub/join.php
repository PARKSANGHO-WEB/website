...
?>
			...
			if(!document.frm.info_ck.checked){
				alert('회원가입 이용약관에 동의를 해주세요.');
				return false;	
			}
			if(!document.frm.info_ck2.checked){
				alert('회원가입 개인정보처리방침에 동의를 해주세요.');
				return false;	
			}
			document.frm.submit();
			return;		
        ...
        <section>
            <div class="join">
                <p>회원가입</p>
                <span>코비인사이트를 방문해 주셔서 감사합니다.<br />회원가입 후 이용해주세요.</span>
            </div>
            <div class="join_f">
                <form name="frm" id="frm" action="join_action.php"  method="post"  enctype="multipart/form-data">
				<input type="hidden" name="id_ok" id="id_ok" value=""/>
				<input type="hidden" name="member_type" id="member_type" value="GEN"/>
                <input type="hidden" name="member_gubun" id="member_gubun" value="NOR"/>  
				<input type="hidden" name="sns_kind" id="sns_kind" value="<?=$sns_kind?>"/>  
				<input type="hidden" placeholder="이메일을 주소를 입력하세요" name="user_id" value="<?=$user_id?>">	
					<div class="form-wrap">

				<?
					if($sns_kind=="nv"){
				?>
					<input type="hidden" placeholder="이름을 입력하세요" name="user_name" value="<?=$user_name?>">						
				<?
						}else if($sns_kind=="kt" || $sns_kind=="gp"){
						?>
					 <div class="line_2">
                            <span class="title">
                                이름
...
<!--
					   <div class="line_3">
						...
						?>    
							<input type="text" placeholder="이메일을 주소를 입력하세요" name="user_id" value="<?=$user_id?>">
						<?}else{?>
							<input type="text" placeholder="이메일을 주소를 입력하세요" name="user_id" id="member_id">
                            <div class="dupli">
                                <button type="button" onClick="javascript:ch_id();">중복확인</button>
								<div id="check_id" style="paddig-top:10px;"></div>
                            </div>
							 <div class="e-serti">
                                <button type="button" onclick="javascript:auth_id()">인증하기</button>
								<div id="check_id2" style="paddig-top:10px;"></div>
                            </div>
							 <input type="text" placeholder="인증번호를 입력하세요" name="sign_key" id="sign_key">
							 <div class="e-serti">
                                <button type="button" onclick="javascript:auth_key()">인증확인</button>
							<div id="check_key" style="paddig-top:10px;"></div>
                            </div>

						<?}?>
						<span class="l2-info">이메일 주소가 아이디로 사용됩니다.</span>
                        </div>
...
<!--
						...
						<?
						if($sns_kind=="nv" || $sns_kind=="gp"){
						?>
                            <input type="text" placeholder="이름을 입력하세요" name="user_name" value="<?=$user_name?>">						
						<?
						}else{
						?>
							<input type="text" placeholder="이름을 입력하세요" name="user_name">	
                        ...
                        <div class="line_4">
                            ...
                            <input id="password" type="password" placeholder="비밀번호를 입력하세요." name="user_pwd">
                            <input id="confirm_password" type="password" placeholder="비밀번호를 다시 한 번 입력해주세요." name="user_pwd_re">
                        ...
                        <div class="line_5">
                            ...
                            <input  name="birthday1" maxlength="6" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" >
                            <span class="hypen" placeholder="생년월일">-</span>
                            <input  name="birthday2" maxlength="1"oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" >
...
-->
                        <div class="line_6">
                            ...
                            <input type="text" name="cell2" maxlength="4" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                            <span class="hypen">-</span>
                            <input type="text" name="cell3" maxlength="4"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
                        </div>
                         <div class="line_8">
                            <span class="title">
                                소속회사
                            </span>
                            <input type="text" name="com_name" placeholder="회사명을 입력해주세요.">
                        </div>
                        <div class="line_9">
                            <span class="title">
                                직책
                            </span>
                            <input type="text" name="jobposition" placeholder="직책을 입력해주세요">
                        </div>
                        <div class="line_10">
                            <span class="title">
                                회사주소
                            ...
                            <input type="text" name="com_addr" placeholder="동/읍/면까지 입력해주세요.">
                        ...
                        <div class="line_11">
                            ...
                            <label class="consult" for="consult"><input type="radio" name="consult" id="consult" value="컨설턴트">컨설턴트</label>
                            <label class="company" for="company"><input type="radio" name="consult" id="company" value="기업임직원">기업임직원</label>
                        </div>
						
						<div class="line_1">
                            <div class="line_1left">
                                <div class="text-box"><p class="text-pu"><span class="u-title">코비인사이트(주) 홈페이지 이용약관<br/>(www.kobiinsight.co.kr)</span><br /><br />
...
본 약관은 2020년 11월 1일 제정되었으며, 제정과 함께 회사에서 운영하는 사이트에 공지함으로써 그 효력이 발생합니다.<br /><br />
                                ...
                                <div class="agree-wrap">
                                    <label for="agree">
                                        <input type="checkbox" name="info_ck" value="Y">
                                        코비인사이트 이용약관에 동의
                                    </label>
                                </div>
                            </div><div class="line_1right">
                                <div class="text-box"><p class="text-pu"><span class="u-title">코비인사이트(주) 홈페이지 <br/>개인정보처리방침</span><br /><br />
...
<br /><br />
        ...
        개인정보를 보관하고 있는 물리적 보관 장소를 별도로 두고 이에 대해 출입통제 절차를 수립, 운영하고 있습니다.<br /><br />
                                ...
                                <div class="agree-wrap">
                                    <label for="agree">
                                        <input type="checkbox" name="info_ck2" value="Y">
                                        코비인사이트 개인정보처리방침에 동의
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form_btn">
                            ...
                            <button type="button" onclick="go_submit();">회원가입</button>
                        </div>
                    </div>
                </form>
            </div>
