...
function init_Onload(){
	...
	function go_submit2() {
            ...
            <div class="login login_sec">
                <p>회원가입</p>
                <span>코비인사이트를 방문해 주셔서 감사합니다.<br />보유하신 SNS계정으로 회원가입 후 이용해주세요.</span>
            </div>
            <div class="login_f">
...
-->
					<div class="sns-wrap">
                        <ul>
                            <li id="naver_id_login">
                                ...
                                <span><a class="login_st" href="javascript:;">네이버계정으로 회원가입</a></span>
							</li>
                            <li>
                                <span><img src="../img/sns/kakao.png" alt=""></span>
                                <span><a class="login_st" href="javascript:loginWithKakao();">카카오톡계정으로 회원가입</a></span>
                            </li>
							 <li>
                                <span><img src="../img/sns/google.png" alt=""></span>
                                <span><a class="login_st" href="javascript:;" id="google_join_btn">구글계정으로 회원가입</a></span>
                            </li>
            ...
            <script>
                $(document).ready(function(){
                    $('#naver_id_login').find('a:nth-child(2)').text('네이버계정으로 회원가입')
                });
            </script>
<!--
            <div class="remember">
