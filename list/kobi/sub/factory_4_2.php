...
<? include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/include_default.php"; // 공통함수 인클루드 ?>
    ...
    <div id="navbar" class="about_tab sticky">
        <div class="at-wrap">
    ...
    <section>
        ...
        <div class="fac_ban sector" style="display:none;">
             <p class="fac_title">
...
?>
   ...
   $(document).ready(function(){
      fnMove("<?=$_REQUEST['go_div']?>");
        ...
        <div class="fac4-1 sector" id="board_list_area">
		...
		<div class="filter-btn">
               <ul id="filterOptions">
                    ...
                    <li><a class="nomu" href="javascript:go_list2('노무');">노무 컨설팅</a></li>
