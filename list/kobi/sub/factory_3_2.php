...
$total_param = 'field='.$field.'&keyword='.$keyword.'&bbs_code='.$bbs_code."&bbs_sect2=".$bbs_sect2."&go_div=board_list_area";
...
?>
    ...
    function fnMove(divname){
      ...
      var go_top = Number(offset.top)+10; // + 뒤의 수치는 적절하게 조절 
        $('html, body').animate({scrollTop : go_top}, 100);
    }
   ...
   $(document).ready(function(){
      fnMove("<?=$_REQUEST['go_div']?>");
        ...
        <div class="fac3-1 sector" id="board_list_area">
            <p class="con-ment">컨설팅에 관한 <span class="bold">궁금한 점</span>을 남겨주세요.<br />코비인사이트의 <span class="bold">전문가들</span>이 친절하게 답변 드립니다.</p>
             <div class="filter-btn">
               <ul id="filterOptions">
                    <li><a class="all" href="javascript:go_list();">전체</a></li>
                    <li><a class="semu" href="javascript:go_list2('세무');">세무 컨설팅</a></li>
                    <li><a class="bub" href="javascript:go_list2('법무');">법무 컨설팅</a></li>
                    <li><a class="nomu" href="./factory_4.php?id=board_list_areaboard_list_area">노무 컨설팅</a></li>
                    <li><a class="serty" href="javascript:go_list2('인증');">인증 컨설팅</a></li>
                    <li><a class="any" href="javascript:go_list2('기타');">기타</a>
                 </ul>
            </div>
			...
			<div class="write-btn">
                ...
                <div class="sr-wrap">
                    ...
                    <select name="field" id="sear-cate">
                        <option value="subtent" <?=$field=="subtent"?"selected":""?>>전체</option>
	...
	?>	
			...
			?>
                            ...
                            <div class="page_btn">
                               <?include $_SERVER["DOCUMENT_ROOT"]."/pro_inc/paging2.php";?>
                            </div>
                        </div>
                    </form>
            </div>
                ...
                $(document).ready(function() {
                  $('#filterOptions li a').click(function() {
                    ...
                    if(ourClass == 'all') {
                      ...
                      $('#ourHolder').find('tr:subtent(.' + ourClass + ')').hide();
