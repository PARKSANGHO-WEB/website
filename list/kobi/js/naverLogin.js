 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
			naver_id_login_contents="<a href=''><span><img src='/img/sns/naver.png' alt=''></span><span><a href='"+naver_id_login_url+"' "+naver_id_popup_option+" style='font-weight: 500;font-size: 15px; text-align: center;display: block; color: #fff; line-height: 30px; width:200px; margin-left:50px;'>네이버 로그인</a></span></a>";
			//naver_id_login_contents="<button class='btn' type='button' onclick=naver_login_go('"+naver_id_login_url+"'); "+naver_id_popup_option+" id='naver_id_login_anchor'><span class='ic ic_nv'></span>네이버</button>";
		}
		else if (this.button_type == BANNER_SMALL_TYPE)
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'>2</a> ";
		}
		else 
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'>3</a> ";
		}
		//alert(naver_id_login_contents);
