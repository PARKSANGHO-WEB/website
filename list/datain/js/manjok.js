...
$(document).ready(function(){
        ...
        $(document).on("click",".rbox_bot_1",function(){     
            $(this).parents(".children__item2").clone().insertAfter($(this).parents(".children__item2"));
        ...
        $(document).delegate('.table_add', 'click', function(e) {
            
             var tlength = $(".tr_width").find('.tr_tr').children("table").length;
        ...
        $(document).delegate('.table_addr', 'click', function(e) {
            
             var tlength2 = $(".tr2_width").find('.tr2_tr').children("table").length;
        ...
        $(document).delegate('.jib_bot', 'click', function(e) {
            ...
            if ($(".ser").length >= clonemax) {
               $(".ser").eq(4).remove();
				...
				var $klon_select_p = $div_select_p.prop('id', 'select_type_x_p'+attach_count_1);
        ...
        $(document).delegate('.dec_min1', 'click', function(e) {
            ...
            $(this).siblings('.dec_add').css('display',"block");
              ...
              var itemids3 = $.makeArray($(".main_dec2").find(".item_serv").map(function(){
				...
				$("#decision_2_frm").attr("action","decision_2_child_action.php");
