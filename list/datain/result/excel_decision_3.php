...
<?
	...
	$sql_file_1 = "select analysis_report_decision_100data_quiz_no as quiz_no,analysis_report_decision_100data_quiz_title as quiz_title from wise_analysis_report_decision_100data_detail3 where 1 and decision_option_idx='".$decision_option_idx."' and analysis_report_decision_100data_no='1' order by analysis_report_decision_100data_quiz_no asc";
	$query_file_1 = mysqli_query($gconnet,$sql_file_1);
	$query_file_1_cnt = mysqli_num_rows($query_file_1);
	...
	<head>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				?>	
					<td><?=iconv("UTF-8","EUC-KR",get_decision_100data3_no_val($decision_option_idx,$data_no,$file_1_quizno,$file_1_idx2,$file_1_group2,$file_1_title2))?></td>
				<?}?>
