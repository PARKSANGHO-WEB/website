				...
				<td>
						<table border>
								<tr align="center">
									...
									<td bgcolor=#CCCCCC><font color="#669900"><strong><?=iconv("UTF-8","EUC-KR","빈도")?></strong></font></td>
									<td bgcolor=#CCCCCC><font color="#669900"><strong><?=iconv("UTF-8","EUC-KR","퍼센트")?></strong></font></td>
								</tr>
							<?
							...
							?>
								<tr bgcolor=#ffffff align="center" height="22">
									<td><?=iconv("UTF-8","EUC-KR",$row_file_1['analysis_report_service_data_frequency_no'])?></td>
							...
							?>
								<tr bgcolor=#ffffff align="center" height="22">
									<td><?=iconv("UTF-8","EUC-KR","합계")?></td>
								<?if($query_file_1_cnt > 0){?>
									<td><?=number_format($tot_frequency_val)?></td>
									<td><?=$tot_ratio_val?></td>
								<?}else{
									$sql_file_1 = "select analysis_report_service_data_frequency_val,analysis_report_service_data_ratio_val from wise_analysis_report_service_data_ratio where service_option_idx='".$service_option_idx."' and analysis_report_service_data_frequency_title = '합계'";
									$query_file_1 = mysqli_query($gconnet,$sql_file_1);
									$row_file_1 = mysqli_fetch_array($query_file_1);
									?>
									<td><?=number_format($row_file_1['analysis_report_service_data_frequency_val'])?></td>
				...
				<tr>
					...
					<td>
						<table border>
							<tr align="center">
								...
								<td bgcolor=#CCCCCC colspan="<?=sizeof($file_2_idx_arr)+1?>"><font color="#669900"><strong><?=iconv("UTF-8","EUC-KR","등급")?></strong></font></td>
							</tr>
							<tr align="center">
						<?
						...
						?>
							<td bgcolor=#CCCCCC><font color="#669900"><strong><?=iconv("UTF-8","EUC-KR",$file_2_title2)?></strong></font></td>	
						<?} // 등급루프 종료?>
							<td bgcolor=#CCCCCC><font color="#669900"><strong><?=iconv("UTF-8","EUC-KR","전체")?></strong></font></td>
							</tr>
							<tr align="center">
						<?
							for($opt2_i=0; $opt2_i<sizeof($file_2_idx_arr); $opt2_i++){ // 등급루프 시작 
					...
					?>
							<tr bgcolor=#ffffff align="center" height="22">
								<td>
								<?if($opt4_i == 0){?>
									<?=iconv("UTF-8","EUC-KR",$file_1_title2)?>
								<?}?>
								</td>
								<td><?=iconv("UTF-8","EUC-KR",$row_file_4['data_val'])?></td>
								<?
								$val_tot = 0;
								for($opt2_i=0; $opt2_i<sizeof($file_2_idx_arr); $opt2_i++){ // 등급루프 시작 
									$file_2_idx2 = trim($file_2_idx_arr[$opt2_i]);
					...
					<td>
						...
						<?
							for($opt2_i=0; $opt2_i<sizeof($file_2_idx_arr); $opt2_i++){ // 등급루프 시작 
								...
								$file_2_title2 = trim($file_2_title_arr[$opt2_i]);
						?>
							<td bgcolor=#CCCCCC><font color="#669900"><strong><?=iconv("UTF-8","EUC-KR","비율")?></strong></font></td>	
						<?} // 등급루프 종료?>
							<td bgcolor=#CCCCCC><font color="#669900"><strong><?=iconv("UTF-8","EUC-KR","비율")?></strong></font></td>
							</tr>
							...
							<tr bgcolor=#ffffff align="center" height="22">
								...
								?>
								<td><?if($val_tot == 0){?>0<?}else{?><?=($val_tot/$val_tot)*100?><?}?></td>
							</tr>
