...
<?
	...
	$sql_file_2 = "select idx,analysis_report_service_statistics_group_title from wise_analysis_report_service_statistics_group where 1 and service_option_idx='".$service_option_idx."' and (analysis_report_service_statistics_group_no in (select idx from wise_analysis_report_service_option_group where 1 and service_option_idx='".$service_option_idx."') or analysis_report_service_statistics_group_title='합계') order by idx asc";
	...
	<head>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				<td><?=iconv("UTF-8","EUC-KR",$row_file_3['analysis_report_service_statistics_ipa_tabval'])?></td>
				<td><?=iconv("UTF-8","EUC-KR",$row_file_3['analysis_report_service_statistics_ipa_ratio'])?></td>
			</tr>
		<?}?>
			</table>
		</td>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				<td><?=iconv("UTF-8","EUC-KR",$row_file_5['analysis_report_service_statistics_ipa_stf'])?></td>
				<td><?=iconv("UTF-8","EUC-KR",$row_file_5['analysis_report_service_statistics_ipa_imt'])?></td>
			</tr>
		<?}?>
			</table>
		</td>
