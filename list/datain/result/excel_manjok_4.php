		...
		<td>
			...
			<tr align="center">
				...
				<tr bgcolor=#ffffff align="center" height="22">
					...
					<td><?=number_format($data_raw_1)?></td>
					<td><?=number_format($data_raw_2)?></td>
					<td><?=number_format($data_raw_3)?></td>
					<td><?=number_format($data_raw_4)?></td>
					<td><?=number_format($data_raw_t)?></td>
				</tr>
		...
		<td>
			...
			<tr align="center">
				...
				<tr bgcolor=#ffffff align="center" height="22">
					<td></td>
					<td><?=iconv("UTF-8","EUC-KR","전체")?></td>
					<td><?=round($data_raw_t1/$data_raw_tt*100,1)?> %</td>
					<td><?=round($data_raw_t2/$data_raw_tt*100,1)?> %</td>
					<td><?=round($data_raw_t3/$data_raw_tt*100,1)?> %</td>
					<td><?=round($data_raw_t4/$data_raw_tt*100,1)?> %</td>
					<td><?=round($data_raw_tt/$data_raw_tt*100,1)?> %</td>
				</tr>
			...
			?>
				<tr bgcolor=#ffffff align="center" height="22">
					...
					<td><?if($data_raw_t1){?><?=round($data_raw_1/$data_raw_t1*100,1)?><?}else{?>0<?}?> %</td>
					<td><?if($data_raw_t2){?><?=round($data_raw_2/$data_raw_t2*100,1)?><?}else{?>0<?}?> %</td>
					<td><?if($data_raw_t3){?><?=round($data_raw_3/$data_raw_t3*100,1)?><?}else{?>0<?}?> %</td>
					<td><?if($data_raw_t4){?><?=round($data_raw_4/$data_raw_t4*100,1)?><?}else{?>0<?}?> %</td>
					<td><?=round($data_raw_t/$data_raw_tt*100,1)?> %</td>
				</tr>
			<?
				$group_title = $row_file_3['analysis_report_satisfaction_data_group_title'];
				}
