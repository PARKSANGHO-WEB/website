	...
	<head>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				<td><?=iconv("UTF-8","EUC-KR",$row_file_3['analysis_report_satisfaction_statistics_ipa_tabval'])?></td>
				<td><?=iconv("UTF-8","EUC-KR",$row_file_3['analysis_report_satisfaction_statistics_ipa_ratio'])?></td>
			</tr>
		<?}?>
			</table>
		</td>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				<td><?=iconv("UTF-8","EUC-KR",$row_file_5['analysis_report_satisfaction_statistics_ipa_stf'])?></td>
				<td><?=iconv("UTF-8","EUC-KR",$row_file_5['analysis_report_satisfaction_statistics_ipa_imt'])?></td>
			</tr>
		<?}?>
			</table>
		</td>
